...
def generate_ma_satellite_list(cursor, source_name, source_object):
    ...
    SELECT DISTINCT 
        ...
        Load_Date_Column,Multi_Active_Attributes
    from 
        (SELECT DISTINCT 
            hs.MA_Satellite_Identifier,
            ...
            src.Load_Date_Column,hs.Multi_Active_Attributes 
        FROM 
            multiactive_satellite hs
        inner join 
...
def generate_ma_satellite(data_structure):
    ...
    satellite_list = generate_ma_satellite_list(cursor, source_name, source_object)
